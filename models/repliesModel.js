...
exports.createReply = (reply_contents, user_no, post_no, wrt_date, cb) => {
    const sql = "INSERT INTO REPLY (reply_contents, user_no, post_no, wrt_date) VALUES (?, ?, ?, ?)";
    const sqlLastInsert = "UPDATE REPLY SET bundle_id = LAST_INSERT_ID() WHERE reply_no = LAST_INSERT_ID()"
